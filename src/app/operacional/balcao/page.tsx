...
export default function BalcaoPage() {
  ...
  useEffect(() => {
    if (!isAuthenticating && !user) {
      router.push('/login?redirect=/operacional/balcao');
    }
  ...
  const handleTransformarEmOS = () => {
    ...
    router.push(`/operacional/produtos-servicos/atendimentos/novo?${queryParams.toString()}`);
  };
            ...
            <CardContent>
              ...
              {!isLoadingProducts && filteredAvailableProducts.length === 0 && (
                <div className="text-center py-10">
                  ...
                  <Button onClick={() => router.push('/operacional/produtos-servicos/produtos')} className="mt-4">Cadastrar Produtos/Serviços</Button>
                </div>
              )}
